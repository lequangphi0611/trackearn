...
1. **Gắn chi phí sửa chữa cho từng máy**: **không** ở giai đoạn này — chi phí sửa trừ ở lãi gộp mảng, không gắn từng device (MVP).
2. **Hoàn tác bán** ("hủy bán" khi khách trả máy): **có** — thao tác đảo `status` về `in_stock` + huỷ transaction income (và công nợ nếu có).
3. **Phụ kiện lẻ**: bán **kèm máy** → ghi mảng `thiet_bi`; bán **lẻ độc lập** → ghi mảng `phu_kien` (xem [accessories.md](./accessories.md)).
