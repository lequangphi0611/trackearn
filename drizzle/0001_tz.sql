...
ALTER TABLE "transactions" ALTER COLUMN "transacted_at" SET DATA TYPE timestamp with time zone;--> statement-breakpoint
ALTER TABLE "transactions" ALTER COLUMN "transacted_at" SET DEFAULT now();--> statement-breakpoint
